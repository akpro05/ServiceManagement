...
type StatusResponse struct {
	CnpsTransactionID     string `json:"cnps_transaction_id"`
	CnpsEntityID          string `json:"cnps_entity_id"`
	CnpsDeclarationID     string `json:"cnps_declaration_id"`
	DeclarationPeriod     string `json:"declaration_period"`
	BankReferenceNumber   string `json:"bank_reference_number"`
	Amount                string `json:"amount"`
	PartialPayment        string `json:"partial_payment"`
	TransactionEndDate    string `json:"transaction_end_date"`
	Currency              string `json:"currency"`
	Description           string `json:"description"`
	PgsTransactionID      string `json:"pgs_transaction_id"`
...
func CnpsPgwStatusHandler(w http.ResponseWriter, r *http.Request) {

	fmt.Println("---------------- Request at CnpsPgwStatusHandler --------------")

	var resp StatusResponse
	var paybillresponse StatusResponse

	var getservicerequest CheckStatusRequest
	...
	fmt.Println("SuperpayPgsHandler request", string(request))

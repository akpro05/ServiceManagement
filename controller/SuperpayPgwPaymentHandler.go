...
type PayResponse struct {
	...
	Txn_Number     string `json:"txn_number"`
	Code           string `json:"code"`
}

func SuperpayPgwPaymentHandler(w http.ResponseWriter, r *http.Request) {

	fmt.Println("---------------- Request at SuperpayPgwPaymentHandler --------------")

	var resp GetserviceResponse
	var paybillresponse PayResponse

	var getservicerequest entity.SuperpayPgsRequest
